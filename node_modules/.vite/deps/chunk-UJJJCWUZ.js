...
} from "./chunk-I6JUEUY7.js";
import {
  c,
  i,
  m,
  x
} from "./chunk-W45GCGNF.js";
import {
  require_jsx_runtime
...
function g(n, t) {
  let o;
  return (...i3) => {
    window.clearTimeout(o), o = window.setTimeout(() => n(...i3), t);
  };
}
function j({ debounce: n, scroll: t, polyfill: o, offsetSize: i3 } = { debounce: 0, scroll: false, offsetSize: false }) {
  const a = o || (typeof window == "undefined" ? class {
  } : window.ResizeObserver);
  if (!a) throw new Error("This browser does not support ResizeObserver out of the box. See: https://github.com/react-spring/react-use-measure/#resize-observer-polyfills");
  const [c2, h] = (0, import_react2.useState)({ left: 0, top: 0, width: 0, height: 0, bottom: 0, right: 0, x: 0, y: 0 }), e = (0, import_react2.useRef)({ element: null, scrollContainers: null, resizeObserver: null, lastBounds: c2, orientationHandler: null }), d = n ? typeof n == "number" ? n : n.scroll : null, f = n ? typeof n == "number" ? n : n.resize : null, w = (0, import_react2.useRef)(false);
  (0, import_react2.useEffect)(() => (w.current = true, () => void (w.current = false)));
  const [z, m2, s] = (0, import_react2.useMemo)(() => {
    const r = () => {
      if (!e.current.element) return;
      const { left: y, top: C, width: H, height: O, bottom: S, right: x2, x: B, y: R } = e.current.element.getBoundingClientRect(), l = { left: y, top: C, width: H, height: O, bottom: S, right: x2, x: B, y: R };
...
function E(n) {
  ...
  const { overflow: o, overflowX: i3, overflowY: a } = window.getComputedStyle(n);
  return [o, i3, a].some((c2) => c2 === "auto" || c2 === "scroll") && t.push(n), [...t, ...E(n.parentElement)];
}
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UJJJCWUZ.js.map
