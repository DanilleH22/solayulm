...
const AirlockJournal = () => {
  ...
  <Row className="text-center mb-4">
    <Col>
      ...
      <p><strong>Write down your thoughts, worries, or reflections. When ready, release them into the black hole.</strong></p>
    </Col>
  </Row>
  ...
  <Row className="justify-content-center mt-3">
    ...
    <Col xs="auto">
      ...
      <Button className={styles.sendBtn}>Send to Black Hole</Button>
